...
void WebServer::sql_pool()
{
    ...
    m_connPool->init("localhost", m_user, m_passWord, m_databaseName, 3306, m_sql_num, close_log_);
...
{
    users[connfd].init(connfd, client_address, m_root, m_CONNTrigmode, close_log_, m_user, m_passWord, m_databaseName);
    ...
    timer->user_data_ = &users_timer[connfd];
